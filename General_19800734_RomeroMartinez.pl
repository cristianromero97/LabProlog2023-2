...
chatHistory(Nombre,InitialChatbotCodeLink,Chatbot,NuevosChatbots,Usuarios,UsuarioLogeado,Fecha,[Nombre,InitialChatbotCodeLink,Chatbot,NuevosChatbots,Usuarios,UsuarioLogeado,Fecha] ).
